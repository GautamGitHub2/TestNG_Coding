...
public class HomePageImagesAddToBasket {
    /*
      1) Open the browser
    ...
    */
    ...
    @Test
    public void HomePageImagesAddToBasket_Method() throws InterruptedException
    {
        ...
        Thread.sleep(5000);
        WebElement Price= driver.findElement(By.xpath("//div//p//span[@class='woocommerce-Price-amount amount']"));
        Assert.assertEquals("₹350.00",Price.getText());
        System.out.println("The Book Price has been verified...");
